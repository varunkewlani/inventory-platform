...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleValidation(MethodArgumentNotValidException ex) {
        ...
        ApiResponse<Map<String, String>> body = new ApiResponse<>(false, fieldErrors, null,
                new com.inventoryplatform.common.response.ApiError("VALIDATION_ERROR", "Request validation failed"));
